    ...
    <footer className="bg-sand">
      ...
      <div className="container-latour grid gap-12 border-t border-line py-16 sm:grid-cols-2 lg:grid-cols-3">
        <div>
          ...
          <a
            href={site.phoneHref}
            className="tap mt-2 text-brand transition-opacity hover:opacity-70"
          >
            {site.phone}
          </a>
        </div>
        ...
        <div>
          ...
          <ul className="mt-5 space-y-2">
            {footerLinks.map((link) => (
              <li key={link.label}>
                <Link
                  href={link.href}
                  className="tap justify-start text-stone transition-colors hover:text-brand"
                >
                  {link.label}
                </Link>
              </li>
          ...
          <div className="mt-4 flex flex-wrap gap-x-6 gap-y-1">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="eyebrow tap text-brand underline underline-offset-4"
            >
              Nous localiser
            </a>
            <Link href="/contact" className="eyebrow tap text-brand underline underline-offset-4">
              Nous laisser un mot
            </Link>
          </div>
        </div>
